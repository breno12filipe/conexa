...
@Component({
    selector: 'app-rooms-schedules',
    templateUrl: './rooms-schedules.component.html',
    styleUrls: ['./rooms-schedules.component.css']
})
export class RoomsSchedulesComponent implements OnInit {
    ...
    private source: any = {
        ...
        id: 'id',
        url: 'https://www.jqwidgets.com/jquery-widgets-demo/demos/interactivedemos/fitnessmanager/data.php?usedwidget=roomsscheduler'
    };
