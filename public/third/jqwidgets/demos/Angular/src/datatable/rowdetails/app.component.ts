import { Component, ViewChild, AfterViewInit } from '@angular/core';  import { jqxDataTableComponent } from 'jqwidgets-ng/jqxdatatable';  @Component({     selector: 'app-root',     templateUrl: './app.component.html'
